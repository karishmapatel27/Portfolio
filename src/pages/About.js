      ...
      <div className="max-width">
        ...
        <div className="about-content">
          ...
          <div className="column right">
            ...
            <p>
              I am a self-motivated and highly enthusiastic full-stack developer and recent graduate of Web-development Bootcamp from Espiral Dev Academy. My background includes bachelors in Information and Communication Technology from Manukau Institute of Technology, as well as customer service experience from various roles.  <br /><br />
